...
class BantuTemanSMP extends StatefulWidget {
  final ItemSMP item;
  final String id;

  BantuTemanSMP({@required this.item, this.id});

  @override
  _BantuTemanSMPState createState() => _BantuTemanSMPState();
}

class _BantuTemanSMPState extends State<BantuTemanSMP> {
