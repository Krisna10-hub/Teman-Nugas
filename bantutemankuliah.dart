...
class BantuTemanKULIAH extends StatefulWidget {
  final ItemKULIAH item;
  final String id;

  BantuTemanKULIAH({@required this.item, this.id});

  @override
  _BantuTemanKULIAHState createState() => _BantuTemanKULIAHState();
}

class _BantuTemanKULIAHState extends State<BantuTemanKULIAH> {
